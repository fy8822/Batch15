    ...
    public static void main(String[] args) {
      ...
      * Cell(1,1)= 78    Cell(1,2)= 54    Cell(1,3)= 100    Cell(1,4)= 84
        ...
        * */
        ...
        System.out.println("myExcel[0].length : " + myExcel[0].length); // getting the length of first 1D array
        System.out.println("myExcel[1].length : " + myExcel[1].length); // getting the length of second 1D array
        System.out.println("myExcel[2].length : " + myExcel[2].length); // getting the length of third 1D array
        System.out.println();
