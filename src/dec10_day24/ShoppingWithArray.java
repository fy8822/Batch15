...
//
//        for (String eachFruit : groceryItems) {                              //groceryItems[lastItemIndex];
//            System.out.print(eachFruit);
//
//            if (!eachFruit.equals(lastGroceryItem)) {
//                System.out.print(" -->  ");
//            }
//        }
        ...
        String[] groceryItems2 = {"Eggplant", "Ginger", "Squash"};

        int itemCountGroceryItems2 = groceryItems2.length;
        int lastIndexOfGroceryItems2 = itemCountGroceryItems2 - 1;

        String lastVeggie = groceryItems2[groceryItems2.length-1];

        for (String eachVegie : groceryItems2) {
            System.out.print(eachVegie);

                if(!eachVegie.equals(lastVeggie)){
                    System.out.print( " -->> ");
                }
