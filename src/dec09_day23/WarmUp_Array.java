...
public class WarmUp_Array {
    public static void main(String[] args) {
        ...
        int[] nums2 = new int[]{11, 2, 23, 4, 53, 6, 3};          // 2nd way to create an array with values

        int[] nums3 = {11, 2, 23, 4, 53, 6, 3};                    // 3rd and shortest way tHIS MUST HAPPEN IN ONE LINE , WE CAN NOT DECLARE FIRST AND ASSIGN LATER

        for (int x = nums.length - 1; x >= 0; x--) {
            System.out.println("index " + x + " : " + nums[x]);    // REVERSE PRINTING
        }
